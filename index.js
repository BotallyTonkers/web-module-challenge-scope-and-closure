...
/*Task 1: counterMaker()
  ...
  counter 1 is function scoped and counter 2 is global scoped
  
  2. Which of the two uses a closure? How can you tell?
  counter 1 uses a closure because it is defined within the function brackets
  
  3. In what scenario would the counter1 code be preferable? In what scenario would 
     counter2 be better?  
     counter 1 would be better for one time use counter 2 would be good for being used multiple times
*/
...
console.log(`3:`, finalScore(inning, 9));
